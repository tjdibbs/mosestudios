        ...
        <AnimatePresence mode="popLayout">
          {pageKey !== "success" ? (
            <motion.form
              ...
              id={pageKey}
              className="bg-[#fff] text-black border border-solid border-yellow-600 shadow-2xl px-10 py-10 rounded-xl w-[450px] max-w-full"
            >
              <Link href={"/"}>
                ...
                <>
                  ...
                  <div className="form-control max-w-[400px] mx-auto">
                    <Input.Password
                      ...
                      onChange={({ target }) =>
                        setFormState((s) => ({ ...s, password: target.value }))
                      }
                      autoComplete="off"
                      name="new-password"
