...
function RegisterPage() {
  ...
  return (
    <div className="register-container w-screen h-screen grid place-items-center">
      {!registered ? (
        <div className="bg-white border border-solid border-primary/50 rounded-2xl shadow-2xl shadow-[#fff]/50 w-[500px] p-6 text-black">
          {Logo}
        ...
        <div className="registered text-center bg-white border border-solid border-primary/50 rounded-2xl shadow-2xl shadow-[#fff]/50 w-[500px] p-6 pb-8 text-black">
          {Logo}
