...
import BrandingImage from "@assets/services/branding.gif";
      ...
      <div className="flex flex-wrap-reverse px-4 gap-10 justify-around items-center max-w-6xl mx-auto py-10">
        <div className="text-wrap max-w-lg text-center">
          ...
          <div className="desc font-extralight my-4 text-base sm:text-2xl text-textDark">
            Branding is vital for a business, influencing customer perception
            and setting it apart from competitors. Maintaining a positive
            customer perception is key for sustained success.
          </div>
